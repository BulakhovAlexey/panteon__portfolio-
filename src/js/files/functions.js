...
//================================================================================================================================================================================================================================================================================================================
//lобавление BG color у header при скроле

export function addBgToHeader() {
  let myHeaderClass = document.querySelector("header");
  window.addEventListener("scroll", function () {
    if (window.pageYOffset > myHeaderClass.clientHeight) {
      myHeaderClass.classList.add("showBg");
    } else {
      myHeaderClass.classList.remove("showBg");
    }
  });
}
//========================================================================================================================================================
